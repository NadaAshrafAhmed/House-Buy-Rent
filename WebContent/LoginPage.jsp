...
<section class="form-simple sect">
    ...
    <div class="card">
        ...
        <!--Header-->
            ...
            <!--          <p class="font-small grey-text d-flex justify-content-end">Forgot <a href="file:///C:/Users/Karim/Downloads/bootstrap-4.0.0-alpha.6-dist/mdbootstrap/index.html#" class="dark-grey-text font-bold ml-1"> Password?</a></p>-->
                </div>
                ...
                <p class="font-small grey-text d-flex justify-content-center">Don't have an account? <a href="RegisterPage.html" class="dark-grey-text font-bold ml-1"> Sign up</a></p>
